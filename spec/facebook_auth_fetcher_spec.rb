...
RSpec.describe FacebookAuthFetcher do
  it "has a version number" do
    expect(FacebookAuthFetcher::VERSION).not_to be nil
  end
  ...
  describe '#self.fetch_token' do
    it 'should raise FacebookAuthenticationError if wrong email or password given' do
      ...
      expect { FacebookAuthFetcher.fetch_token('wrong email', 'wrong_password', app_id) }.to raise_error(FacebookAuthFetcher::FacebookAuthenticationError, 'Facebook Authentication failed. Check if you passed correct email and password')
    end
    ...
    it 'should raise FacebookAuthenticationError if invalid app id specified' do
      ...
      expect { FacebookAuthFetcher.fetch_token(email, password, 'invalid app id') }.to raise_error(FacebookAuthFetcher::FacebookAuthenticationError, 'Facebook Authentication failed. Invalid App ID specified')
    end
    ...
    it 'should fetch a correct token' do
      ...
      token = FacebookAuthFetcher.fetch_token(email, password, app_id)
